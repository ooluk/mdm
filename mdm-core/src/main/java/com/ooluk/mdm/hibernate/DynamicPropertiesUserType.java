 ...
 */
package com.ooluk.mdm.hibernate;
...
public class DynamicPropertiesUserType implements UserType {
	...
	public void nullSafeSet(PreparedStatement st, Object value, int index,
		...
		try {
			...
			json = mapper.writeValueAsString(data.getAllProperties());
	...
	public Object deepCopy(Object value) throws HibernateException {
		...
		DynamicProperties copy = new DynamicProperties(original.getAllProperties());
		return copy;
	}
