...
public class DynamicProperties {
	...
	/**
	 * Constructs an instance with the specified property mappings. The DynamicProperties object
	 * will not hold a reference to the map but it will hold a reference to the map's values.
	 * 
	 * @param mappings
	 *            key-value pairs
	 */
